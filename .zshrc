...
alias gompile='g++ -Wall -std=c++17 -Og -c *.cpp && g++ -Wall -std=c++17 -Og -o main *.o -lsfml-graphics -lsfml-window -lsfml-system'
...
export LESS=-r
export PATH="$HOME/.cask/bin:$HOME/.emacs.d/bin:$PATH"
...
# man `find /usr/share/man/man1 -type f | awk -F / '{print $6}' | sed -e "s/.gz//g" | shuf | head -n 1`
