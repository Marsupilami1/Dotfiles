 ...
 %--------PACKAGES--------%
 \usepackage[utf8]{inputenc}		% ~ Compilation
 \usepackage[T1]{fontenc}		% ~ Pour écrire correctement français
 \usepackage{lmodern}			% ~ Pour écrire correctement français
 \usepackage[a4paper]{geometry}	% ~ Mise en page
 \usepackage{fancyhdr}			% ~ Modification de la page
 \usepackage{import}				% ~ Appel aux sous fichiers
 \usepackage{amssymb}			% ~ Mathématiques
 \usepackage{mathtools}			% ~ Mathématiques
 \usepackage[hidelinks]{hyperref}	% ~ Accès direct aux chapitres
 \usepackage[explicit]{titlesec}		% ~ Mise en page
 \usepackage{titletoc}			% ~ Table des matières
 \usepackage{tabto}				% ~ Tabulation
 \usepackage{ntheorem-hyper}		% ~ Théorème perso
 \usepackage{etoolbox}			% ~ Pour lstlisting
 \usepackage{ifthen}				% ~ Conditions
 \usepackage{xspace}				% ~ Commandes avec texte
 ...
 \usetikzlibrary{decorations.text}				% ~ Texte courbe Tikz
 \usepackage{tkz-tab}			% ~ Tableaux TIKZ
 \usepackage[straightvoltages]{circuitikz}		% ~ Circuits électriques TIKZ
 \usepackage[squaren, cdot, derived]{SIunits}	% ~ Unités du système international
 \usepackage{graphicx}			% ~ Couleurs
 \usepackage[f]{esvect}			% ~ Vecteurs
 \usepackage[version=4]{mhchem}	% ~ Chimie
 \usepackage{chemfig}			% ~ Molécules
 \usepackage{transparent}
 \usepackage[many]{tcolorbox}	% ~ Théorèmes en boites
 \usepackage[french]{babel}		% ~ Pour écrire correctement français
 \usepackage{listings}			% ~ Pour de beaux morceaux de code
 \usepackage{eurosym}			% ~ €
 ...
 % ~ Modification de \overrightarrow{}, inutile car esvect chargé
 ...
 \newcommand{\moment}[2]{\vv{\mathcal{M}_{#1}}\pof{\vv{#2}}}
 ...
 % ~ Pour la numérotaion des parties.
 ...
 {0pt}
 {\parbox[b]{4cm}
 	{\sffamily\fontsize{120}{110}\selectfont\thechapter}
 	\ifthenelse{\thechapter<10}
 	{\parbox[b]{12cm}{\raggedleft \hfill{\Huge\sffamily#1}\\
 			\rule{12cm}{1.3pt}}}
 	{\parbox[b]{10.5cm}{\raggedleft \hfill{\Huge\sffamily#1}\\
 			\rule{10cm}{1.3pt}}}
 }
 ...
 {0pt}
 {
 	...
 	\node at (current page.north west) [yshift = -12.85cm, xshift=10.5cm] {\includegraphics[]{figures/logo_avant.pdf}};
 	\node at (current page.north west) [yshift=-11.4cm, xshift=10.5cm] {\LARGE\partname \thepart};
 	\node at (current page.north west) [yshift=-13cm, xshift=10.5cm] {\LARGE #1};
 	\end{tikzpicture}
 }
 ...
 {\addvspace{1pc}}{}
 {\bfseries\Large}
 {\hfill\bfseries\contentspage}[\addvspace{.5pc}]
 
 \titlecontents{chapter}[2pc]
 {}
 {\bfseries\thecontentslabel\tabto{2pc}\normalsize\normalfont}
 {}
 ...
 \newcommand{\Theoreme}[1]{
 	\begin{tcolorbox}[enhanced, attach boxed title to top left={yshift=-4mm, xshift = -3.9mm}, adjusted title=Théorème, colback=white, colframe=black, colbacktitle=white, coltitle=black, fonttitle=\bfseries, breakable, sharp corners, boxed title style={colback=white, sharp corners, colframe=white}, boxrule = 0.7mm, drop fuzzy shadow]
 		#1
 	\end{tcolorbox}
 }
 ...
 \newcommand{\bil}{bilinéaire\xspace}
 \newcommand{\mat}[1]{\mathcal{M}_{#1}(\R)}
 
 %-------------/DOCUMENT\-----------------%
 
 \author{\textsc{Andrieux} Martin\\MPSI 1}
 \date{}
 \title{}
